...
Download `Whisper UI.cmd` from [this page](https://dan-the-meme-man.github.io/whisper-ui/). Place it wherever you like on your computer. You can launch the program by running this file. Expect it to take a bit of time to start up the first time you run it as it installs itself.

### Linux/Mac

Download `Whisper UI.sh` from [this page](https://dan-the-meme-man.github.io/whisper-ui/). Place it wherever you like on your computer. You can launch the program by running this file. Expect it to take a bit of time to start up the first time you run it as it installs itself.
